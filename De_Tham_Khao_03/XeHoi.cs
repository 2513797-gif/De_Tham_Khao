...
{
    internal class XeHoi : IXeHoi, IPhuongTien
    {
        ...
        public void Lai()
        {
            Console.WriteLine($"Xe co ten {Ten} dang chay voi toc do {TocDo} ");
        }
        public XeHoi(string ten, int tocDo, double nhienLieu, double soKMDaDi, int namSanXuat, string nhaSanXuat)
        {
            Ten = ten;
            TocDo = tocDo;
            NhienLieu = nhienLieu;
        ...
        {
            return $"Xe: {Ten} || Toc do: {TocDo} || Nhien lieu: {NhienLieu} || So Km:  {SoKMDaDi}  || NSX:  {NamSanXuat}  || NSX:  {NhaSanXuat}";
        }
